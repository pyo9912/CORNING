...
# python komain.py --gpu=3 --version='ko' --task=resp --log_name="KO_Sch_<S>256RAG_know_resp측정_1e-4" --rag_lr=1e-4 --rag_epochs=10 
# python komain.py --gpu=3 --version='ko' --task=resp --log_name="KO_Sch_<S>256RAG_know_resp측정_1e-5" --rag_lr=1e-5 --rag_epochs=10 
# python komain.py --gpu=3 --version='ko' --task=resp --log_name="KO_Sch_<S>256RAG_know_resp측정_1e-6" --rag_lr=1e-6 --rag_epochs=10 
