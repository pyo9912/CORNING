...
# python main.py --task=know --batch_size=32 --know_max_length=128 --num_epochs=20 --input_prompt=dialog_topic --log_name=RB_RG_794topic2_conf50_hj --model_name=RB_794RG_topic2_conf50_hj --topk_topic=2 --topic_conf=0.5 --train_ablation=RG --device=0
# python main.py --task=know --batch_size=32 --know_max_length=128 --num_epochs=20 --input_prompt=dialog_topic --log_name=RB_RG_794topic2_conf40_hj --model_name=RB_794RG_topic2_conf40_hj --topk_topic=2 --topic_conf=0.4 --train_ablation=RG --device=0
# python main.py --task=know --batch_size=32 --know_max_length=128 --num_epochs=20 --input_prompt=dialog_topic --log_name=RB_RG_794topic2_conf30_hj --model_name=RB_794RG_topic2_conf30_hj --topk_topic=2 --topic_conf=0.3 --train_ablation=RG --device=0
# python main.py --task=know --batch_size=32 --know_max_length=128 --num_epochs=20 --input_prompt=dialog_topic --log_name=RB_RG_794topic2_conf20_hj --model_name=RB_794RG_topic2_conf20_hj --topk_topic=2 --topic_conf=0.2 --train_ablation=RG --device=0
# python main.py --task=know --batch_size=32 --know_max_length=128 --num_epochs=20 --input_prompt=dialog_topic --log_name=RB_RG_794topic2_conf10_hj --model_name=RB_794RG_topic2_conf10_hj --topk_topic=2 --topic_conf=0.1 --train_ablation=RG --device=0
