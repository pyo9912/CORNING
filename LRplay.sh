...
python unimind_main.py --fast --version=2 --gpu=1 --method=t5 --uni_lr=1e-5 --uni_epochs=7 --topic_rq_label=resp --uni_model_name='google/flan-t5-large' --uni_max_input_length=256 --uni_max_target_length=128 --uni_batch_size=8 --topic_score=794 --topk_topic=2 --topic_rq=conf --topic_conf=0.8 --log_name="T5_794_T5_RecGen_Cum2_Conf80" 
