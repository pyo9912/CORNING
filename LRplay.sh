...
python preprocess_bm25.py --mode=test --how=resp_uttr_item --score_method=contriever --gpu=1 --log_name=contriever-msmarco

python preprocess_bm25.py --mode=test --how=resp_uttr_item --score_method=contriever --gpu=1
python preprocess_bm25.py --mode=test --how=resp_uttr_item --score_method=dpr --gpu=1 --log_name=PreTrainedDPR
